...
*** Root directory for GTD-related stuff
#+BEGIN_SRC emacs-lisp
(setq gtd-base-path (expand-file-name "~/Projects/"))
(defun prepend-gtd-base-path (sub-path) (concat gtd-base-path sub-path))
#+END_SRC
*** Specify agenda-relevant files
#+BEGIN_SRC emacs-lisp
(setq org-agenda-files (mapcar 'prepend-gtd-base-path '("inbox.org" "projects.org" "tickler.org")))
#+END_SRC
* Helm & Projectile
#+BEGIN_SRC emacs-lisp
(use-package helm
