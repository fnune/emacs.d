...
#+END_SRC
* Flycheck
Flycheck is used for on-the-fly linting. We want it to display linter warnings and errors on the right fringe, because otherwise it conflicts with the line numbers.
